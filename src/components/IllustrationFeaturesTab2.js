const IllustrationFeaturesTab2 = () => {
    return (
        <div className="flex-1 bg-neutral-svgBgGray rounded-3xl">
            <div className="absolute -left-48 bottom-48 z-[-1] w-[575px] h-[225px] bg-primary-blue rounded-r-[150px] md:top-64 md:w-[500px] lg:w-[800px] lg:h-[350px] lg:top-[52%]"></div>
            <svg
            ...
            >
                <defs>
                    ...
                    <filter id="c" width="117.5%" height="113.7%" x="-8.8%" y="-4.9%" filterUnits="objectBoundingBox">
                        ...
                        <feColorMatrix in="shadowBlurOuter1" values="0 0 0 0 0.285332669 0 0 0 0 0.363695184 0 0 0 0 0.811480978 0 0 0 0.0830692745 0" />
                    </filter>
                    <filter id="e" width="139.5%" height="131%" x="-19.8%" y="-13.5%" filterUnits="objectBoundingBox">
                        <feOffset dy="5" in="SourceAlpha" result="shadowOffsetOuter1" />
                        <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1" stdDeviation="5" />
                        <feColorMatrix in="shadowBlurOuter1" result="shadowMatrixOuter1" values="0 0 0 0 0.285332669 0 0 0 0 0.363695184 0 0 0 0 0.811480978 0 0 0 0.0830692745 0" />
                ...
                <g fill="none" fill-rule="evenodd"><mask id="b" fill="#fff">
                    ...
                    <use fill="#E8EAF6" fill-rule="nonzero" href="#a" />
                    <g mask="url(#b)">
                    ...
                    <g transform="translate(27 138)"><use fill="#000" filter="url(#c)" href="#d" />
                        <use fill="#FFF" href="#d" />
                    ...
                    <g filter="url(#e)" transform="translate(251 138)">
                        <use fill="#000" filter="url(#f)" href="#g" />
                        <use fill="#FFF" href="#g" />
                        <g transform="translate(23 29)">
                            <rect width="101.317" height="6" x="45.683" y="6" fill="#242A45" opacity=".5" rx="3" />
                            <circle cx="16" cy="16" r="16" fill="#5267DF" />
...
export default IllustrationFeaturesTab2;
